...
- Before proposing any idea, and for current facts or versions, uncertain APIs, or technical claims: MUST challenge it through both `$ai-pilot:research` and `$ai-pilot:fuse-browser-usage`; cross-check the fuse-browser fast path, official docs/Context7, and Exa; docs over memory; unresolved means say "I don't know."
