...
## Getting Started
- [Installation](getting-started/installation.md) - Install plugins, env, hooks
- [Quick Start](getting-started/quick-start.md) - First steps, examples
...
- [commit-pro](plugins/commit-pro.md) - Smart conventional commits
- [laravel](plugins/laravel.md) - Laravel 12+ expert
- [nextjs](plugins/nextjs.md) - Next.js 16+ expert
- [react](plugins/react.md) - React 19 expert
