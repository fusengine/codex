...
This MUST be a separate commit from the code changes. Never combine. **No tag here** — Do not create or push a tag here; same post-merge rationale as Step S2. Load `references/tag-timing.md` for details.
