 ...
 * State stored in ~/.codex/logs/00-apex/YYYY-MM-DD-state.json.
 */
...
const PROTECTED_PATHS = /\.codex\/(plugins\/(marketplaces|cache)|logs\/00-apex|fusengine-cache\/skill-tracking)/;
