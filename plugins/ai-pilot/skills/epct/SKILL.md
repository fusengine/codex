---
name: epct
description: "Systematic Explore-Plan-Code-Test methodology for structured development. Ensures comprehensive approach to feature implementation. (migrated from Codex command workflow)"
---
