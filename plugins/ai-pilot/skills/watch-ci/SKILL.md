---
name: watch-ci
description: "Monitor CI/CD pipeline and automatically fix failures. Watches GitHub Actions runs and applies fixes when tests fail. (migrated from Codex command workflow)"
---
