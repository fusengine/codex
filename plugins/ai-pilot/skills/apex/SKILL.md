---
name: apex
description: "APEX Methodology - The systematic Analyze-Plan-Execute-eLicit-eXamine approach for intelligent development. Eliminates hallucinations,errors,and bugs to produce clean,maintainable code. (migrated from Codex command workflow)"
---
...
**Complete documentation**: `~/.codex/docs/core/apex.md`
...
**See full documentation**: `~/.codex/docs/core/apex.md`
