...
description: "Memory optimization - removes duplicates,consolidates knowledge,and cleans memory banks for better performance. (migrated from Codex command workflow)"
---

# Cleanup Context

Executes the automatic cleanup script for Codex CLI context.
...
```bash
~/.codex/scripts/cleanup-context.sh
```
