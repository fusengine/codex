...
| `gpt-5.6-sol` | 16 orchestration/release/validation/prompt-design/security-audit agents (brainstorming, solid-orchestrator, commit, changelog-watcher, lessons-compactor, seo-expert, seo-content, seo-geo, seo-local, seo-cluster, seo-technical, seo-schema, sniper, prompt-engineer, challenger, security-expert) | `medium` |
| `gpt-5.6-sol` | Highest-judgment gate (`design-expert`) | `high` |
...
- Assign the bare `gpt-5.6` alias, or put a judgment role (design-expert at Sol/high; challenger, sniper, prompt-engineer, security-expert at Sol/medium) on Terra or Luna
