...
**Examples**:
- `/prompts:apex Add user profile editing` → Full APEX for feature
- `/prompts:apex Fix authentication bug` → APEX for bug fix
- `/prompts:apex Refactor payment module` → APEX for refactoring
