...
- `/prompts:watch` - Technical changelog scan + compatibility check
- `/prompts:watch --pulse` - Full scan + community sentiment analysis
- `/prompts:watch --since 1.5.0` - Check changes since specific version

## Modes

### Default Mode (Technical)

1. **Fetch** latest changelog from official Codex changelog and GitHub releases
...
| Source | Method | Mode |
|--------|--------|------|
| Changelog | web fetch official Codex changelog and GitHub releases | Default |
| Docs index | web fetch llms.txt | Default |
