---
description: Neural memory operations - search, store, stats, consolidate
---

# Neural Memory Operations

## Usage
- `/prompts:memory search <query>` - Search lessons
- `/prompts:memory store <lesson>` - Store a lesson manually
- `/prompts:memory stats` - Memory statistics
- `/prompts:memory consolidate` - Force consolidation
- `/prompts:memory decay` - Force decay/pruning
