 ...
 * only validates stdin + a present file_path, then exits 0. Real shadcn
 * detection for the gates lives in the shared shadcn-patterns module. Kept as a
 * registered hook so the wiring is preserved 1:1 with the Python.
 */
...
// observable effect (the computed shadcn-install state was discarded).
