...
- `theme` - CSS theme variables, design tokens, customization
- `functions and directives` - `@utility`, `@variant`, `@theme`, `@apply`
- `adding custom styles` - custom utilities and variants
- `detecting classes in source files` - content detection
- `upgrade guide` - migration from v3 to v4
