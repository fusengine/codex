...
```bash
/prompts:prompt [action] [description]
```
...
```bash
/prompts:prompt create a technical support assistant for a mobile app
```

### Optimize an existing prompt

```bash
/prompts:prompt optimize [paste the prompt to improve]
```

### Design an agent

```bash
/prompts:prompt agent a Python-specialized code reviewer
```

### Analyze a prompt

```bash
/prompts:prompt review [paste the prompt to analyze]
```
