...
description: Index of all references for the generating-components skill
related: gemini-design-workflow.md, 21st-dev.md, shadcn.md
---

# Reference Index — Generating Components

## Concepts

| Topic | Reference | When to Consult |
|-------|-----------|-----------------|
| **Gemini Workflow** | [gemini-design-workflow.md](gemini-design-workflow.md) | MANDATORY - Read first |
| **Tool Signatures** | [gemini-tool-signatures.md](gemini-tool-signatures.md) | create/modify/snippet params |
| **Feedback Loop** | [gemini-feedback-loop.md](gemini-feedback-loop.md) | Retry protocol |
