...
const materialLegacyInventory: MaterialLegacyContractEntry[] = [
	...
	p("two-speed-briefing", "Two-speed communication, ALWAYS", o(/self-contained mandate.*objective and verified context.*expected report/is)),
	...
	s("mandatory-analyze-trio", "ALWAYS launch ALL 3 agents in a SINGLE message", o(/Add exploration, research, or domain specialists only when uncertainty, the routed workflow, or the user requires them/i), "The old unconditional trio contradicted its own scope ladder; the routed skill now selects only specialists justified by the task."),
	...
	p("smallest-delegation", "Scope ladder — take the smallest tool that suffices.", o(/Choose the smallest useful delegation.*one qualified executor.*parallel agents only for independent batches/is)),
	...
	p("team-size", "team is MINIMUM 4 subagents", o(/team means at least four agents when capacity permits/i)),
	...
	p("self-contained-mandate", "Mandate self-contained", o(/self-contained mandate.*objective and verified context.*acceptance criteria.*proof commands.*expected report/is)),
