...
const materialLegacyInventory: MaterialLegacyContractEntry[] = [
	...
	s("smallest-delegation", "Scope ladder — take the smallest tool that suffices.", o(/no scope ladder and no "too small to delegate" case.*at least three domain experts.*generated PRD of tasks.*coordinator checks every task/is), "Owner doctrine (2026-09-01): every task runs the full APEX workflow; the scope ladder was removed because it let executors skip the Analyze trio and the multi-expert execution."),
